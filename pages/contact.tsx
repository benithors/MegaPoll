    ...
    return (
        <Container>
            ...
            <InformationContainer title={'How to Contact us'}>
                If you have any questions, feedback, complaints please feel free to contact us at any time via <EmailContactButton/>
                <br/>
                You may also contact us via the following social media channels
                <button className={'btn-link px-1'}>
                    <a href={'https://twitter.com/socialpollme'} aria-label={"twitter to the creator of this website"}>
                        Twitter
                    </a>
                </button>
                <button  className={'btn-link'}>
                    <a href={'https://github.com/benithors'}  aria-label={"github to the creator of this website"}>
