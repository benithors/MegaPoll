...
const CreatePoll = () => {
    const [pollQuestionFormData, setPollQuestionFormData] = React.useState<IPollQuestionCreation[]>([getEmptyPollItem()]);
        ...
        if (selectedImage) {
            ...
            new Compressor(selectedImage, {
                async success(result) {
                    let uploadImageResp = await supabaseClient.storage.from("pollimages").upload(path, result);
