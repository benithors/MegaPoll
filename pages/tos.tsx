      ...
      <div className={'flex flex-col px-6'}>
        ...
        <InformationContainer title={'Things you should not do'}>
          <ul className={'ml-5 list-disc'}>
            ...
            <li>
              Do NOT illegal content such as child porn or nonconsensual revenge
              porn
            </li>
            <li>
              Do NOT hotlink to adult content or to file-sharing, gambling,
              torrent
            </li>
            <li>
        ...
        <InformationContainer title={'Rights of use'}>
          ...
          verify extensive use of the Platform.
        </InformationContainer>
        ...
        >
          ...
          regardless of the form of that Content. The Operator is not
          responsible for any public display or misuse of the Users Generated
          Content.
        </InformationContainer>
        ...
        <InformationContainer title={'Rights and obligations of the User'}>
          <div>
            ...
            is prohibited from carrying out any actions that scan or test weak
            points of the software, bypass security systems or access systems of
            the software or integrate malware into the software.
          </div>

          <div>
            The User guarantees that he has all the necessary rights (such as
            copyright, ancillary copyright, industrial property rights,
            trademark rights) for processing the uploaded photos. The User is
        ...
        <InformationContainer title={'Concluding provisions'}>
          <div>
            ...
            International Sale of Goods, the referral standards of the IPRG and
            the Regulation (EC) no. 593/2008 of the European Parliament and of
            the Council of June 17, 2008 on the law applicable to contractual
            obligations (Rome I Regulation) is excluded.
          </div>
