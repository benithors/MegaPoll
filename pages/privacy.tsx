    ...
    <Container>
      ...
      <div className={"flex flex-col px-6"}>
        ...
        >
          ...
          affecting us.
          <br />
          Data is also stored and used if you have given your consent to the
          processing of personal data for one or more specific purposes. <br />
          Personal data is data from which a natural person can be identified.
          Therefore, all those data are personal that allow conclusions about
          your person, e.g. your nickname in combination with your email
          address.
          <br />
        ...
        <InformationContainer title={"Data Processing"}>
          ...
          <ul className="ml-8 list-disc pt-2">
            ...
            <li>for the technical provision of our services</li>
          </ul>
          We store and process your data only for as long as is necessary to
          fulfill the respective purposes. <br />
          The duration of data processing also depends in particular on the
          statutory retention periods and the limitation periods for potential
          legal claims. <br />
        </InformationContainer>
