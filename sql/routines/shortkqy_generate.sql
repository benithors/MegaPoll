create function shortkey_generate() returns trigger
    language plpgsql
as
$$
DECLARE
...
alter function shortkey_generate() owner to postgres;

grant execute on function shortkey_generate() to anon;

grant execute on function shortkey_generate() to authenticated;

grant execute on function shortkey_generate() to service_role;
