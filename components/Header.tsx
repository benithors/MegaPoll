          ...
          <div className="dropdown-end dropdown ">
            <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
              {user ? (
                ...
                <IconUser className={"stroke-2 stroke-primary-content"} size={40} />
              )}
            </label>

            <ul
              tabIndex={0}
              className="menu-compact  dropdown-content menu shadow-2xl w-52 bg-base-100 bg-neutral-content p-2 text-black shadow"
            >
              {user ? (
                <>
                  <li>
